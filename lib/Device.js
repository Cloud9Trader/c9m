...
// const host = 'iot.cloud9metrics.com'
  ...
  getAuthTokens (accessKey) {
    return (callback) => {
      request({
        ...
        if (version < 2) {
          return callback('Your Cloud9Metrics version is out of date. Please upgrade to latest `npm install c9m@latest --save`');
        }
